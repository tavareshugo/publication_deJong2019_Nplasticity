...
This document provides with the code to analyse data from a small N-pulse experiment.
...
trend in that more plastic lines respond more to the pulse. (the 
sample size is very small, so this is only a tentative hypothesis)
