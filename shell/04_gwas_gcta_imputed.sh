...
#$-N gcta_imputed
#$-o $HOME/projects/20150501_accessions/scripts/shell/04_gwas_gcta_imputed.stout
#$-e $HOME/projects/20150501_accessions/scripts/shell/04_gwas_gcta_imputed.sterr
#$-pe smp 6
#$-hold_jid basic_imputed

## qsub ~/projects/20150501_accessions/scripts/shell/04_gwas_gcta_imputed.sh

cd ~/projects/20150501_accessions/

#### Create output directory ####

mkdir -p ./gwas/imputed/
...
bed='../../genotypes/imputed/pygwas_genotypes_maf5'
